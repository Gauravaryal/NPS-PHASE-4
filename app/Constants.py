...
class SOA_FILEPATH():
    ...
    if Phase_Constants.CURRENT_PHASE_NUMBER==Phase_Constants.PHASE4:
        ...
        NICAsia_SOA_FILE = os.path.join(FolderPath.SOA_Folder, "Commission_NEW NPS RECEIVABLE.csv")
        ...
        SIDDHARTHA_SOA_FILE = os.path.join(FolderPath.SOA_Folder, 'Commission_Siddhartha Bank - NPS PAYABLE (NEPAL PAYMENT SOLUTION).csv')
