...
class Scraping_process(QRComponent):
    ...
    def NIBL_bank_statement_scraping(self):
        try:
            ...
            # date_put = f'{yesterday_date[1]}/{yesterday_date[2]}/{yesterday_date[0]}'
            # print(date_put)
            # self.browser.wait_until_element_is_visible("//input[@id='ctl00_ContentPlaceHolder1_btnExport']", 60)#clcikc on export button
            # self.browser.set_element_attribute('//input[@id="ctl00_ContentPlaceHolder1_calStart_textBox"]', 'value', date_put)
            # self.browser.set_element_attribute('//input[@id="ctl00_ContentPlaceHolder1_calEnd_textBox"]', 'value', date_put)
    ...
    def sign_in_RBB(self):
        ...
        self.browser.input_text("//input[@id='password']",'rbbnps@1234')
        self.browser.click_button("//button[@type='submit']")
